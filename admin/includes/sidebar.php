...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <img src="logo-sispa-removebg.png" alt="KOR SISPA UTHM Logo">
    ...
    <?php if($role=='admin'){ ?>
        ...
        <li><a href="physical-tests.php">💪 <span>Physical Test</span></a></li>
...
function toggleDropdown() {
    document.getElementById("reportSubmenu").classList.toggle("show");
}
</script>
